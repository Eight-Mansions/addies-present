@echo off
set filename=Addies-Present-English
set file_type=BIN
set patch_file=patch.xdelta3
...
echo FILE "addie_2.bin" BINARY>>%filename%.cue
echo   TRACK 02 AUDIO>>%filename%.cue
echo       INDEX 00 00:00:00>>%filename%.cue
echo       INDEX 01 00:02:00>>%filename%.cue
echo FILE "addie_3.bin" BINARY>>%filename%.cue
echo     TRACK 03 AUDIO>>%filename%.cue
echo       INDEX 00 00:00:00>>%filename%.cue
echo       INDEX 01 00:02:00>>%filename%.cue
echo FILE "addie_4.bin" BINARY>>%filename%.cue
echo     TRACK 04 AUDIO>>%filename%.cue
echo       INDEX 00 00:00:00>>%filename%.cue
echo       INDEX 01 00:02:00>>%filename%.cue
echo.
